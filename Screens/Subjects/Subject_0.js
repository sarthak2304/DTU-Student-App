...
const Header = ({navigation}) => (
    <SafeAreaView >
        <View style={styles.header}>
            ...
            <Text style={{ justifyContent: 'center', flex: 0.9, color: 'white', fontSize: 30, textAlign: 'center',   fontWeight: 'bold' }}>
                {SUBJECTS[0].Code}
            </Text>
        </View>
    </SafeAreaView>
...
const Subject = () => (
    <View style={{ margin: 10, flexDirection: 'row' }}>
        ...
        <Text style={styles.basic}>{SUBJECTS[0].subject}</Text>
    </View>
)
...
const TeacherName = () => (
    <View style={{ margin: 10, flexDirection: 'row' }}>
        ...
        <Text style={styles.basic}>{SUBJECTS[0].professor}</Text>
    </View>
)
