    ...
    <SafeAreaView >
        <View style={styles.header}>
            ...
            <View style={{ justifyContent: 'center', flex: .9 }}>
                <Text style={{ color: 'white', fontSize: 30, textAlign: 'center', fontWeight: 'bold' }}>{SUBJECTS[4].Code}</Text>
            </View>
        </View>
    </SafeAreaView>
)
...
const Subject = () => (
    <View style={{ margin: 10, flexDirection: 'row' }}>
        ...
        <Text style={styles.basic}>{SUBJECTS[4].subject}</Text>
    </View>
)
...
const TeacherName = () => (
    <View style={{ margin: 10, flexDirection: 'row' }}>
        ...
        <Text style={styles.basic}>{SUBJECTS[4].professor}</Text>
    </View>
)
...
const Subject_0 = ({navigation}) => {
    return (
        <View style={{ backgroundColor: 'black', flex: 1 }}>
            <View style={{ backgroundColor: '#1F2833', borderBottomLeftRadius: 20, borderBottomRightRadius: 20, flexGrow: .2}}>
