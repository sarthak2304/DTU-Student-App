    ...
    <SafeAreaView >
        <View style={styles.header}>
            ...
            <View style={{ justifyContent: 'center', flex: .9 }}>
                <Text style={{ color: 'white', fontSize: 30, textAlign: 'center', fontWeight: 'bold' }}>{SUBJECTS[5].Code}</Text>
            </View>
        </View>
    </SafeAreaView>
)
...
const Subject = () => (
    <View style={{ margin: 10, flexDirection: 'row' }}>
        ...
        <Text style={styles.basic}>{SUBJECTS[5].subject}</Text>
    </View>
)
...
const TeacherName = () => (
    <View style={{ margin: 10, flexDirection: 'row' }}>
        ...
        <Text style={styles.basic}>{SUBJECTS[5].professor}</Text>
    </View>
)
